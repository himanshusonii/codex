...
const courseCategories = [
  {
    ...
    desc: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum harum voluptas modi ipsa? Cupiditate excepturi quod nostrum officiis eveniet optio!",
...
const advantages = [
  {
    ...
    title: "Best Teacher",
    desc: "Our Educators are highly qualified, and they know how to increase the passion of children toward Science.",
  },
  {
    icon: "flaticon-clipboard-with-pencil",
    title: "Competitive Events",
    desc: "We prepare students for competitive events such as MIT Science bowl etc.",
  },
  {
    icon: "flaticon-ruler-and-pencil",
    title: "Standard Science Curriculum",
    desc: "Science Courses For Kids USA Our teaching is alligned to NGSS framwork.",
  },
  {
...
const testimonials = [
  {
    text: "This was our first time lorem ipsum and we were very pleased with the whole experience. Your price was lower than other companies. Our experience so we’ll be back in the future lorem ipsum diamet.",
...
const CampPage = () => {
  ...
  return (
    <>
      ...
      <section
        id="course-category"
        className="course-category-section exsciton-cc-sec py-16"
      >
        <div className="container">
          <div className="section-title mb-10 text-center" data-aos="zoom-in">
            ...
            <p>
              Science Experiments Courses For Kids, Ap Physics Test Prep In USA,
              Virtual Science Programs For Kids In USA, Ap Chemistry Online
              Courses In USA, Best Middle School Science Curriculum In USA, Best
              Science Experiments For Kids In USA, Ap Exam Preparation Online In
              USA
            </p>
          </div>
          {courseCategories.map((cat, idx) => (
            <div className="category-item my-12" key={idx}>
              <div className="row align-items-center">
                <div
                  className={`col-md-6 ${idx % 2 === 0 ? "" : "order-md-2"}`}
                ...
                <div
                  className={`col-md-6 ${idx % 2 === 0 ? "" : "order-md-1"}`}
      ...
      <section
        id="why-choose"
        className="why-choose-section exsciton-why backgroud-style shapedividers_com-5596 py-16"
      >
        <div className="container">
          <div
            className="section-title mb-10 text-center text-dark"
            data-aos="zoom-in"
          >
      ...
      <section
        ...
        className="secound-testimoinial-section exsciton-tetstimonial shapedividers_com-1614 py-16"
      >
        <div className="container">
